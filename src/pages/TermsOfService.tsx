        ...
        <div className="space-y-12">
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('terms.section1.title')}</h2>
            </div>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('terms.section2.title')}</h2>
            </div>
            <div className="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-400 leading-relaxed">
              <p>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('terms.section3.title')}</h2>
            </div>
            <div className="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-400 leading-relaxed">
              <p>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('terms.section4.title')}</h2>
            </div>
            <div className="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-400 leading-relaxed">
              <p>
          ...
          <section className="p-8 bg-emerald-500/5 rounded-3xl border border-emerald-500/10">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">{t('terms.contact.title')}</h2>
